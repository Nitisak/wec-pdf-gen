...
export async function fillAcroForm(payload: PolicyCreate): Promise<Uint8Array> {
  ...
  if (pageCount >= 2) console.log(`  Page 2: Internal (blank)`);
  if (pageCount >= 3) console.log(`  Page 3: Customer Copy`);
